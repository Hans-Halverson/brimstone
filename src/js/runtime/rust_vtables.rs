...
const RUST_VTABLES: [*const (); RustVtable::Last as usize] = [
    ...
    UInt8ArrayObject::VIRTUAL_OBJECT_VTABLE,
    UInt8ClampedArrayObject::VIRTUAL_OBJECT_VTABLE,
    Int16ArrayObject::VIRTUAL_OBJECT_VTABLE,
    UInt16ArrayObject::VIRTUAL_OBJECT_VTABLE,
    Int32ArrayObject::VIRTUAL_OBJECT_VTABLE,
    UInt32ArrayObject::VIRTUAL_OBJECT_VTABLE,
    Float16ArrayObject::VIRTUAL_OBJECT_VTABLE,
    Float32ArrayObject::VIRTUAL_OBJECT_VTABLE,
    Float64ArrayObject::VIRTUAL_OBJECT_VTABLE,
    BigInt64ArrayObject::VIRTUAL_OBJECT_VTABLE,
    BigUInt64ArrayObject::VIRTUAL_OBJECT_VTABLE,
    // Modules
    SourceTextModule::MODULE_VTABLE,
    SyntheticModule::MODULE_VTABLE,
    // TypedArrays
    Int8ArrayObject::TYPED_ARRAY_VTABLE,
    UInt8ArrayObject::TYPED_ARRAY_VTABLE,
    UInt8ClampedArrayObject::TYPED_ARRAY_VTABLE,
    Int16ArrayObject::TYPED_ARRAY_VTABLE,
    UInt16ArrayObject::TYPED_ARRAY_VTABLE,
    Int32ArrayObject::TYPED_ARRAY_VTABLE,
    UInt32ArrayObject::TYPED_ARRAY_VTABLE,
    Float16ArrayObject::TYPED_ARRAY_VTABLE,
    Float32ArrayObject::TYPED_ARRAY_VTABLE,
    Float64ArrayObject::TYPED_ARRAY_VTABLE,
    BigInt64ArrayObject::TYPED_ARRAY_VTABLE,
    BigUInt64ArrayObject::TYPED_ARRAY_VTABLE,
];
