...
pub struct BytecodeFunction {
    ...
    feedback_vector: Option<HeapPtr<FeedbackVector>>,
...
impl BytecodeFunction {
    pub fn new(
        ...
        feedback_vector: Option<Handle<FeedbackVector>>,
    ...
    #[inline]
    pub fn feedback_vector_ptr(&self) -> Option<HeapPtr<FeedbackVector>> {
