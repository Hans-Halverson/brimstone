...
use crate::{
    common::{
        ...
        unicode::{
            CodePoint, CodeUnit, code_point_from_surrogate_pair, is_ascii,
            is_high_surrogate_code_unit, is_latin1, is_low_surrogate_code_unit, is_newline,
            is_surrogate_code_point, is_whitespace, needs_surrogate_pair,
